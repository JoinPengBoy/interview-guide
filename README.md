...
### 简历与面试
用户注册/登陆认证系统：![img.png](img.png)![img_1.png](img_1.png)

国际化i18n支持:![img_2.png](img_2.png)

图形验证码：见登陆页面。

用户体验优化：![img_3.png](img_3.png)
...
│   │   │   └── security/             # Spring Security 配置预留（二开新增）
│   │   ├── infrastructure/           # 基础设施
│   │   │   ├── export/               # PDF 导出
